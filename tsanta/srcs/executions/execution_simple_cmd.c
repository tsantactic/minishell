...
/*   Updated: 2024/12/10 16:16:45 by sandriam         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int is_builtin(char *command)
{
    if (ft_strcmp(command, "cd") == 0)
        return (1);
    if (ft_strcmp(command, "pwd") == 0 || ft_strcmp(command, "/bin/pwd") == 0 || ft_strcmp(command, "/usr/bin/pwd") == 0)
        return (2);
    if (ft_strcmp(command, "export") == 0)
        return (3);
    if (ft_strcmp(command, "unset") == 0)
        return (4);
    if (ft_strcmp(command, "env") == 0 || ft_strcmp(command, "/bin/env") == 0 || ft_strcmp(command, "/usr/bin/env") == 0)
        return (5);
    if (ft_strcmp(command, "exit") == 0)
        return (6);
    if (ft_strcmp(command, "echo") == 0 || ft_strcmp(command, "/bin/echo") == 0 || ft_strcmp(command, "/usr/bin/echo") == 0)
        return (7);
    return (0);
}
